...
',
        ...
        if (null !== $password) {
            ...
            $password = $this->io->askHidden('Password (your type will be hidden) he must contain one tiny letter, one capitalize letter and one number', [$this->validator, 'validatePassword']);
